        ...
        <CardHeader className="bg-blue-500 text-white rounded-t-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1 md:gap-2 shrink-0">
              <Button size="sm" variant="secondary" className="bg-blue-600 hover:bg-blue-700 text-white border-0 w-8 h-8 p-0">
          ...
          <div className="p-3 md:p-4 border-b bg-white">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <div className="sm:ml-4">
                <span className="text-xs md:text-sm text-gray-600">Nilai Total Proyek</span>
                <div className="text-lg md:text-xl font-bold">{project.totalValue}</div>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:block">
            ...
            <div className="bg-white">
              {project.activities.map((activity, activityIndex) => (
                <div key={activityIndex} className="grid grid-cols-5 gap-1 p-3 text-sm border-b hover:bg-gray-50">
              ...
              <div key={activityIndex} className="p-4 border-b border-gray-200">
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="font-semibold text-sm">{activity.ruangLingkup}</div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2 border-t border-gray-100">
                    <div>
                      ...
                      <div className="space-y-1 text-xs">
                        <div className="flex justify-between">
                          <span>Anggaran</span><span>0</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Realisasi</span><span>0</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Deviasi</span><span className="text-red-600">0</span>
                        </div>
    ...
    <div className="min-h-screen bg-gray-50 p-2 md:p-4">
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-4 md:mb-6">
          <h1 className="text-xl md:text-3xl font-bold text-gray-800 mb-1 md:mb-2">Dashboard Revitalisasi Prasarana dan Sarana</h1>
          <p className="text-sm md:text-base text-gray-600">Monitoring seluruh kegiatan proyek pembangunan dan pengembangan</p>
          
          {/* Summary Stats */}
          <div className="mt-3 md:mt-4 grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
            <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
              <CardContent className="p-3 md:p-4">
                <div className="text-xs md:text-sm opacity-90">Total Semua Proyek</div>
                <div className="text-sm md:text-xl font-bold">Rp {totalAllProjects.toLocaleString('id-ID')}</div>
              </CardContent>
            </Card>
            <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
              <CardContent className="p-3 md:p-4">
                <div className="text-xs md:text-sm opacity-90">Jumlah Proyek</div>
                <div className="text-lg md:text-2xl font-bold">{projects.length}</div>
              </CardContent>
            </Card>
            <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
              <CardContent className="p-3 md:p-4">
                <div className="text-xs md:text-sm opacity-90">Total Aktivitas</div>
                <div className="text-lg md:text-2xl font-bold">{totalActivities}</div>
              </CardContent>
            </Card>
