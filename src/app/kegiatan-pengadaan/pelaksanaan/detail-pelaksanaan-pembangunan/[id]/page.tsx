  ...
  return (
    <Mainlayout>
      <Accordion type="single" collapsible>
        <AccordionItem value="perencanaan">
          <AccordionTrigger>Konsultan Perencanaan </AccordionTrigger>
          <AccordionContent>
            <div className="">
                  ...
                  <div className="grid grid-cols-4 gap-5">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={
                          watch("hps")
                            ? `Rp ${Number(watch("hps")).toLocaleString(
                                "id-ID"
                              )}`
                            : ""
                        }
        ...
        <AccordionItem value="konstruksi">
          <AccordionTrigger>Kontruksi </AccordionTrigger>
          <AccordionContent>
            <div className="">
              <div className="mx-auto p-6 bg-white shadow rounded-lg">
                {/* Header dengan tombol Edit */}
        ...
        <AccordionItem value="pengawasan">
          ...
          <AccordionContent>
            <div className="">
              <div className="mx-auto p-6 bg-white shadow rounded-lg">
                ...
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-lg font-semibold">
                    Data Pengawasan Konsultan Pengawas
                  </h2>
                  {!isEdit && (
                    <button
                      type="button"
